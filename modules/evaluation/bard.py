...
def cascading_classifiers(X, y):
    """
    This function performs cascading classification using logistic regression.
    ...
    for i in range(len(hierarchy) - 1):
        ...
        clf.fit(X, y_filtered)

    # Initialize the metaclassifier.
    metaclf = VotingClassifier(estimators=classifiers, voting='hard')
...
if __name__ == "__main__":
    ...
    # Fit the classifier.
    classifiers = cascading_classifiers(X, y)
